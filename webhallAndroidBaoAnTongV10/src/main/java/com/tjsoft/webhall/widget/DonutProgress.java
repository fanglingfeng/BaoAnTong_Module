...
import com.tjsoft.webhall.util.DpUtils;
...
public class DonutProgress extends View {
    ...
    public DonutProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = DpUtils.sp2px(getResources(), 18);
        min_size = (int) DpUtils.dp2px(getResources(), 100);
        default_stroke_width = DpUtils.dp2px(getResources(), 10);
        default_inner_bottom_text_size = DpUtils.sp2px(getResources(), 18);
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        setProgress(attributes.getInt(R.styleable.DonutProgress_progress, 0));
