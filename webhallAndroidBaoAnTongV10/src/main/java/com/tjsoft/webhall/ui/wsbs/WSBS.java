 ...
 * 
 */
public class WSBS extends AutoDialogActivity {
	...
	private List<Map<String, Object>> listItemDeclared; // 可申报事项列表
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(MSFWResource.getResourseIdByName(this, "layout", "tj_wsbs"));
		...
		initSetListener();
		dialog = Background.Process(WSBS.this, InitParentArea, "数据加载中...");
		...
		btnSearch.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (TextUtils.isEmpty(textSearch.getText().toString())) {
					DialogUtil.showUIToast(WSBS.this, getString(MSFWResource.getResourseIdByName(WSBS.this, "string", "tj_search_empty_notice")));
				} else {
					intent = new Intent();
					intent.setClass(WSBS.this, PermListByName.class);
	...
	private void showMore(View v) {
		...
		layoutSearch.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				startActivity(new Intent().setClass(WSBS.this, Search.class));
		...
		layoutReserve.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (null == Constants.user) {
					...
					util.checkLogin(WSBS.this);
				} else {
					startActivity(new Intent().setClass(WSBS.this, ReserveList.class));
				}
		...
		layoutWDBJ.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (null == Constants.user) {
					...
					startActivity(new Intent().setClass(WSBS.this, WDBJ.class));
				}
		...
		layoutFavorit.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				startActivity(new Intent().setClass(WSBS.this, PermListByDB.class));
	...
	private void showPopLeft(View v) {
		...
		reserve.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(WSBS.this, ReserveList.class);
				startActivity(intent);
			}
		});
		favorite.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent();
				intent.setClass(WSBS.this, PermListByDB.class);
				startActivity(intent);
			}
		});
		search.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent();
				intent.setClass(WSBS.this, Search.class);
				startActivity(intent);
			}
		});
		dealwith.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				LoginBaoAnTongUtil.checkLogin(WSBS.this);
...
//							gloabDelegete.loginMST(WSBS.this);
//							return;
...
//							intent = new Intent();
//							intent.setClass(WSBS.this, Login.class);
...
//								Background.Process(WSBS.this, Login, "正在登录...");
//								return;
//							}
//						}
//
...
//				}
				...
				Intent intent = new Intent();
				intent.setClass(WSBS.this, WDBJ.class);
				startActivity(intent);
			}
		});
		erweima.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent();
				intent.setClass(WSBS.this, CaptureActivity.class);
...
//			item.bg.setLayoutParams(iconSize);
	...
	private void InitViewPager() {
		...
		bmfw = inflater.inflate(MSFWResource.getResourseIdByName(this, "layout", "tj_bmfw"), null);
		...
		deptList = (ListView) bmfw.findViewById(MSFWResource.getResourseIdByName(this, "id", "deptList"));
		ImageView empty = (ImageView) bmfw.findViewById(MSFWResource.getResourseIdByName(this, "id", "empty"));
		deptList.setEmptyView(empty);
		declaredList = (ListView) xtbs.findViewById(MSFWResource.getResourseIdByName(this, "id", "deptList"));
		ImageView empty1 = (ImageView) xtbs.findViewById(MSFWResource.getResourseIdByName(this, "id", "empty"));
		declaredList.setEmptyView(empty1);
	...
	public class MyOnPageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int position) {
			...
			for (int i = 0; i < titles.size(); i++) {
				titles.get(i).setTextColor(MSFWResource.getResourseIdByName(WSBS.this, "color", "tj_tab_text"));
			}
			titles.get(position).setTextColor(WSBS.this.getResources().getColor(MSFWResource.getResourseIdByName(WSBS.this, "color", "tj_my_green")));
			System.out.println("fuchl   onPageSelected   " + position);
			if (position == 2) {
				dialog = Background.Process(WSBS.this, GetDeptList, "数据加载中");
			} else if (position == 3) {
				dialog = Background.Process(WSBS.this, GetZJList, "数据加载中");
			}
		}
	...
	final Runnable InitIcon = new Runnable() {
		...
		public void run() {
			try {
				...
				String response = HTTP.excuteAndCache("getPictureByID", "RestUnitPortalService", param.toString(),WSBS.this);
				...
				if (("200".equals(code))) {
					...
					DialogUtil.showUIToast(WSBS.this, json.getString("error"));
				}

			} catch (Exception e) {
//				DialogUtil.showUIToast(WSBS.this, getString(MSFWResource.getResourseIdByName(WSBS.this, "string", "tj_occurs_error_network")));
				e.printStackTrace();
			}
		}
	};
	...
	final Runnable GetZJList = new Runnable() {
		...
		public void run() {
			try {
				...
				String response = HTTP.excuteAndCache("getDeptlistByAreaid", "RestRegionService", param.toString(),WSBS.this);
				JSONObject json = new JSONObject(response);
				String code = json.getString("code");
				if (code.equals("200")) {
	...
	final Runnable GetCooperateFlowList = new Runnable() {
		...
		public void run() {
			try {
				...
				param.put("PAGENO", "1");
				param.put("PAGESIZE", "1000");
				String response = HTTP.excuteAndCache("getCooperateFlowList", "RestCooperateService", param.toString(),WSBS.this);
				JSONObject json = new JSONObject(response);
				String code = json.getString("code");
				if (code.equals("200")) {
					...
					runOnUiThread(new Runnable() {
						public void run() {
							...
							SimpleAdapter adapter = new SimpleAdapter(WSBS.this, cooperateDatas, MSFWResource.getResourseIdByName(mContext, "layout", "tj_deptlist_item"), new String[] { "CFLOWNAME" }, new int[] { MSFWResource.getResourseIdByName(WSBS.this, "id", "deptName") });
...
//				DialogUtil.showUIToast(WSBS.this, getString(MSFWResource.getResourseIdByName(WSBS.this, "string", "tj_occurs_error_network")));
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case 101:
			...
			dialog = Background.Process(WSBS.this, GetDeptList, "数据加载中");
			dialog = Background.Process(WSBS.this, InitIcon, "数据加载中");
			dialog = Background.Process(WSBS.this, InitDeclareIcon, "数据加载中");
			break;
	...
	final Runnable InitParentArea = new Runnable() {
		...
		public void run() {
			try {
				JSONObject param = new JSONObject();
				param.put("PARENTID", "");
				String response = HTTP.excuteAndCache("getRegionlistByParentid", "RestRegionService", param.toString(),WSBS.this);
				JSONObject json = new JSONObject(response);
				String code = json.getString("code");
				if (("200".equals(code))) {
...
//				DialogUtil.showUIToast(WSBS.this, getString(MSFWResource.getResourseIdByName(WSBS.this, "string", "tj_occurs_error_network")));
	...
	private class MyItemClick implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
			...
			if (currIndex == 2) {
				...
				intent.putExtra("WSBSFLAG", 2);

			} else {
				intent.setClass(WSBS.this, DeptList.class);
				intent.putExtra("WSBSFLAG", 2);
				intent.putExtra("dept", depts.get(position));
			}
			startActivity(intent);
	...
	class MyHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case GET_REGION_SUCCESS:
				...
				dialog = Background.Process(WSBS.this, InitIcon, "数据加载中");// 更新图标
				dialog = Background.Process(WSBS.this, InitDeclareIcon, "数据加载中");// 更新图标
				break;
			case GET_DEPTS_SUCCESS:

				if (currIndex == 2) {
					SimpleAdapter adapter = new SimpleAdapter(WSBS.this, deptDatas, MSFWResource.getResourseIdByName(mContext, "layout", "tj_deptlist_item"), new String[] { "NAME" }, new int[] { MSFWResource.getResourseIdByName(mContext, "id", "deptName") });
					deptList.setAdapter(adapter);
					deptList.setOnItemClickListener(new MyItemClick());
				} else {
					SimpleAdapter adapter = new SimpleAdapter(WSBS.this, listItemDeclared, MSFWResource.getResourseIdByName(mContext, "layout", "tj_deptlist_item"), new String[] { "NAME" }, new int[] { MSFWResource.getResourseIdByName(mContext, "id", "deptName") });
	...
	class GridViewClick implements OnItemClickListener {
		...
		@Override
		public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
			startPermList(icons.get(position).getPICTURECODE(), icons.get(position).getPICTURENAME(),icons.get(position).getPERMCODE());
		}

	}

	private void startPermList(String sortCode, String type,String PermCode) {
		intent = new Intent();
	...
	private void isLoginAlert() {
		new AlertDialog.Builder(this).setMessage("你还没有绑定网上办事大厅账号，是否现在绑定？").setTitle(getString(MSFWResource.getResourseIdByName(WSBS.this, "string", "tj_notify"))).setCancelable(false).setPositiveButton("绑定", new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int id) {
				GloabDelegete gloabDelegete = Constants.getInstance().getGloabDelegete();
				if (gloabDelegete != null) {
					gloabDelegete.doBoundMSTAccount(WSBS.this, username, password, new TransportCallBack() {
			...
			public void onClick(DialogInterface dialog, int id) {
				intent = new Intent();
				intent.setClass(WSBS.this, Register.class);
				startActivity(intent);
			}
		}).show();
	}
	...
	static class MyHandler2 extends Handler {
		private WeakReference<WSBS> logins;

		public MyHandler2(WSBS login) {
			logins = new WeakReference<WSBS>(login);
		}

		@Override
		public void handleMessage(Message msg) {
			super.handleMessage(msg);
			WSBS login = logins.get();
			if (login == null) {
				return;
			}
			switch (msg.what) {
	...
	final Runnable Login = new Runnable() {
		...
		public void run() {
			try {
				...
				String response = HTTP.excuteAndCache("login", "RestUserService", param.toString(),WSBS.this);
				final JSONObject json = new JSONObject(response);
				String code = json.getString("code");
				if (code.equals("200")) {
					Constants.user = JSONUtil.getGson().fromJson(json.getString("ReturnValue"), User.class);
					DialogUtil.showUIToast(WSBS.this, "登录成功！");
				} else {
					String error = json.getString("error");
					DialogUtil.showUIToast(WSBS.this, error);
				}
