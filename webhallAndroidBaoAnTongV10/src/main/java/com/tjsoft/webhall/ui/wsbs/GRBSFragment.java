...
import com.tjsoft.webhall.WSBSMainActivity_v2;
...
import com.tjsoft.webhall.ui.xkzkj.XKZKJActivity_v2;
...
import static com.tjsoft.webhall.WSBSMainActivity_v2.hasGotToken;

public class GRBSFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(MSFWResource.getResourseIdByName(getActivity(), "layout", "tj_wsbs_gr"), container,
                false);
        ...
        tv_test = (TextView) view.findViewById(MSFWResource.getResourseIdByName(getActivity(), "id", "tv_test"));
...
//		dialog=Background.Process(PermGuideContainer.this, LoginNotPassW,PermGuideContainer.this.getString(MSFWResource.getResourseIdByName(PermGuideContainer.this, "string", "tj_loding")));
    ...
    private void showPopLeft(View v) {
        ...
        dealwith.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // gloabDelegete.loginMST(getActivity());
                // return;
                ...
                // Background.Process(getActivity(), Login, "正在登录...");
                // return;
                // }
                // }
                //
    ...
    private void InitViewPager(View view) {
        ...
        //这个radiogroup现在隐藏状态，它是有三个tab(个人主题，事件，人群）
        ...
        mMenu = (Button) view.findViewById(MSFWResource.getResourseIdByName(getActivity(), "id", "wsbs_menu"));//现处于隐藏状态
        ...
        btnMore = (ImageButton) view.findViewById(MSFWResource.getResourseIdByName(getActivity(), "id", "btnMore"));//现处于隐藏状态
    ...
    private void InitTextView(View view) {
        textView2 = (TextView) view.findViewById(MSFWResource.getResourseIdByName(getActivity(), "id", "text2"));
                ...
                if (("200".equals(code))) {
                    ...
                    if (null != icons_declare) {
                        ...
                        for (int i = 0; i < icons_declare.size(); i++) {
                            ...
                            if (temp.getPICTURETYPE().equals("1")) {//类型为个人办事
                                icons_declare_grbs.add(temp);
                            } else if (temp.getPICTURETYPE().equals("2")) {//类型为企业办事
            ...
            try {
                ...
                if (code.equals("200")) {
                    ...
                    for (int i = 0; i < strees.size(); i++) {
                        ...
                        // map.put("NAME",
                        // strees.get(i).getNAME()+"（"+strees.get(i).getPERMNUM()+"）");
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case GET_REGION_SUCCESS:
                    ...
                    dialog = Background.Process(getActivity(), InitIcon, "数据加载中");// 更新图标----全部事项
                    dialog = Background.Process(getActivity(), InitDeclareIcon, "数据加载中");// 更新图标---可申报的事项
                    break;
                ...
                case GET_ZQDEPTS_SUCCESS:
                    ...
                    ZQDeptList.setVisibility(View.GONE);
                    break;
    ...
    private void isLoginAlert() {
        new AlertDialog.Builder(getActivity()).setMessage("你还没有绑定网上办事大厅账号，是否现在绑定？")
                .setTitle(getString(MSFWResource.getResourseIdByName(getActivity(), "string", "tj_notify")))
                .setCancelable(false).setPositiveButton("绑定", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                GloabDelegete gloabDelegete = Constants.getInstance().getGloabDelegete();
                if (gloabDelegete != null) {
                    gloabDelegete.doBoundMSTAccount(getActivity(), username, password, new TransportCallBack() {
    ...
    private void showPopupMore(View view) {
        ...
        if (Constants.user != null) {
            Log.e("点击弹窗获取User信息",Constants.user.toString());

        }
        if (gloabDelegete != null) {
            Log.e("r点击弹窗获取获取gloabDelegete",userInfo.toString());
...
//        popupWindow.showAsDropDown(view,-popupWindow.getWidth()+110,10);
        ...
        jdcx_ll.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                tv_test.setVisibility(View.VISIBLE);
//                tv_test.setText("点击弹窗获取User信息"+Constants.user.toString()+"点击弹窗获取获取gloabDelegete"+userInfo.toString());
                tv_test.setText("点击弹窗获取获取gloabDelegete"+userInfo.toString());
        ...
        qysq_ll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                popupWindow.dismiss();
                Intent intent = new Intent(GRBSFragment.this.getActivity(), FaceAuthActivity.class);
                startActivity(intent);
        ...
        scxkz_ll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                popupWindow.dismiss();
                Intent intent = new Intent(GRBSFragment.this.getActivity(), XKZKJActivity_v2.class);
                startActivity(intent);
            }
        });
    ...
    private boolean checkTokenStatus() {
        if (!hasGotToken) {
            Toast.makeText(this.getContext(), "token还未成功获取", Toast.LENGTH_LONG).show();
        }
        return hasGotToken;
    }
