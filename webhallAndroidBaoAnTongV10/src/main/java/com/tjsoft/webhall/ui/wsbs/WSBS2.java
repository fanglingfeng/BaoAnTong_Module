 ...
 * 
 */
public class WSBS2 extends AutoDialogActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(MSFWResource.getResourseIdByName(this, "layout", "tj_wsbs_qy"));
		...
		initSetListener();
		dialog = Background.Process(WSBS2.this, InitParentArea, "数据加载中...");
	...
	private void InitView() {
		...
		title_radio_group = (RadioGroup) findViewById(
				MSFWResource.getResourseIdByName(this, "id", "title_radio_group"));
		...
		btnSearch.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (TextUtils.isEmpty(textSearch.getText().toString())) {
					DialogUtil.showUIToast(WSBS2.this, getString(MSFWResource.getResourseIdByName(WSBS2.this, "string", "tj_search_empty_notice")));
				} else {
					intent = new Intent();
					intent.setClass(WSBS2.this, PermListByName.class);
	...
	private void showMore(View v) {
		View view = LayoutInflater.from(this)
				.inflate(MSFWResource.getResourseIdByName(this, "layout", "tj_popup_wsbs_more"), null);
		LinearLayout layoutSearch = (LinearLayout) view
				.findViewById(MSFWResource.getResourseIdByName(this, "id", "layoutSearch"));
		LinearLayout layoutReserve = (LinearLayout) view
				.findViewById(MSFWResource.getResourseIdByName(this, "id", "layoutReserve"));
		LinearLayout layoutWDBJ = (LinearLayout) view
				.findViewById(MSFWResource.getResourseIdByName(this, "id", "layoutWDBJ"));
		LinearLayout layoutFavorit = (LinearLayout) view
				.findViewById(MSFWResource.getResourseIdByName(this, "id", "layoutFavorit"));
		layoutSearch.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				startActivity(new Intent().setClass(WSBS2.this, Search.class));
		...
		layoutReserve.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (null == Constants.user) {
					...
					util.checkLogin(WSBS2.this);
				} else {
					startActivity(new Intent().setClass(WSBS2.this, ReserveList.class));
				}
		...
		layoutWDBJ.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (null == Constants.user) {
					...
					startActivity(new Intent().setClass(WSBS2.this, WDBJ.class));
				}
		...
		layoutFavorit.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				startActivity(new Intent().setClass(WSBS2.this, PermListByDB.class));
	...
	private void showPopLeft(View v) {
		View view = LayoutInflater.from(this).inflate(MSFWResource.getResourseIdByName(this, "layout", "tj_wsbs_menu"),
				null);
		...
		reserve.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(WSBS2.this, ReserveList.class);
				startActivity(intent);
			}
		});
		favorite.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent();
				intent.setClass(WSBS2.this, PermListByDB.class);
				startActivity(intent);
			}
		});
		search.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent();
				intent.setClass(WSBS2.this, Search.class);
				startActivity(intent);
			}
		});
...
//							gloabDelegete.loginMST(WSBS2.this);
//							return;
...
//							intent = new Intent();
//							intent.setClass(WSBS2.this, Login.class);
...
//								Background.Process(WSBS2.this, Login, "正在登录...");
//								return;
//							}
//						}
//
...
//				}
				if(null==Constants.user){
					LoginBaoAnTongUtil.checkLogin(WSBS2.this);
				}
				Intent intent = new Intent();
				intent.setClass(WSBS2.this, WDBJ.class);
				startActivity(intent);
			}
		});
		erweima.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent();
				intent.setClass(WSBS2.this, CaptureActivity.class);
	...
	class GridViewAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			ImageLoader.getInstance().displayImage(Constants.DOMAIN + getNewUrl(icons.get(position).getPICTUREPATH()),
					item.bg, options);
//			RelativeLayout.LayoutParams iconSize = new RelativeLayout.LayoutParams(dm.widthPixels / 12,
//					dm.widthPixels / 12);
//			item.bg.setLayoutParams(iconSize);
	...
	private void InitViewPager() {
		...
		qybs = inflater.inflate(MSFWResource.getResourseIdByName(this, "layout", "tj_qybs"), null);
		bmfw = inflater.inflate(MSFWResource.getResourseIdByName(this, "layout", "tj_department"), null);
		xtbs = inflater.inflate(MSFWResource.getResourseIdByName(this, "layout", "tj_can_declared"), null);
		views.add(qybs);
		views.add(bmfw);
		...
		radioGroup2 = (RadioGroup) qybs.findViewById(MSFWResource.getResourseIdByName(this, "id", "radio_group"));
		...
		gridView2 = (GridView) qybs.findViewById(MSFWResource.getResourseIdByName(this, "id", "gridView"));
		...
		StreetList = (ListViewForScrollView) bmfw
				.findViewById(MSFWResource.getResourseIdByName(this, "id", "StreetList"));
	...
	public class MyOnPageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int position) {
			...
			for (int i = 0; i < titles.size(); i++) {
				titles.get(i).setTextColor(MSFWResource.getResourseIdByName(WSBS2.this, "color", "tj_tab_text"));
			}
			titles.get(position).setTextColor(WSBS2.this.getResources()
					.getColor(MSFWResource.getResourseIdByName(WSBS2.this, "color", "tj_my_green")));
			System.out.println("fuchl   onPageSelected   " + position);
			if (position == 1) {
				dialog = Background.Process(WSBS2.this, GetDeptList, "数据加载中");
				dialog = Background.Process(WSBS2.this, GetZQDeptList, "数据加载中");
				dialog = Background.Process(WSBS2.this, GetZJList, "数据加载中");
			}
		}
	...
	final Runnable InitIcon = new Runnable() {
		...
		public void run() {
			try {
				...
				String response = HTTP.excuteAndCache("getPictureByID", "RestUnitPortalService", param.toString(),WSBS2.this);
				...
				if (("200".equals(code))) {
					...
					DialogUtil.showUIToast(WSBS2.this, json.getString("error"));
				}

			} catch (Exception e) {
//				DialogUtil.showUIToast(WSBS2.this,
//						getString(MSFWResource.getResourseIdByName(WSBS2.this, "string", "tj_occurs_error_network")));
				e.printStackTrace();
			}
		}
	};
	...
	final Runnable GetZJList = new Runnable() {
		...
		public void run() {
			try {
				...
				String response = HTTP.excuteAndCache("getDeptlistByAreaid", "RestRegionService", param.toString(),WSBS2.this);
				JSONObject json = new JSONObject(response);
				String code = json.getString("code");
				if (code.equals("200")) {
...
//						map.put("NAME", strees.get(i).getNAME() + "	(" + strees.get(i).getPERMNUM() + ")");
					...
					DialogUtil.showUIToast(WSBS2.this, getString(
							MSFWResource.getResourseIdByName(WSBS2.this, "string", "tj_occurs_error_network")));
					finish();
				}
		...
		public void run() {
			try {
				...
				if (code.equals("200")) {
					...
					DialogUtil.showUIToast(WSBS2.this, getString(MSFWResource.getResourseIdByName(WSBS2.this, "string", "tj_occurs_error_network")));
					finish();
				}
	...
	final Runnable GetCooperateFlowList = new Runnable() {
		...
		public void run() {
			try {
				...
				param.put("PAGENO", "1");
				param.put("PAGESIZE", "1000");
				String response = HTTP.excuteAndCache("getCooperateFlowList", "RestCooperateService", param.toString(),WSBS2.this);
				JSONObject json = new JSONObject(response);
				String code = json.getString("code");
				if (code.equals("200")) {
					...
					runOnUiThread(new Runnable() {
						public void run() {
							...
							SimpleAdapter adapter = new SimpleAdapter(WSBS2.this, cooperateDatas,
									MSFWResource.getResourseIdByName(mContext, "layout", "tj_deptlist_item"),
									new String[] { "CFLOWNAME" },
									new int[] { MSFWResource.getResourseIdByName(WSBS2.this, "id", "deptName") });
...
//						getString(MSFWResource.getResourseIdByName(WSBS2.this, "string", "tj_occurs_error_network")));
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case 101:
			...
			dialog = Background.Process(WSBS2.this, GetDeptList, "数据加载中");
			dialog = Background.Process(WSBS2.this, InitIcon, "数据加载中");
			dialog = Background.Process(WSBS2.this, InitDeclareIcon, "数据加载中");
			break;
	...
	final Runnable InitParentArea = new Runnable() {
		...
		public void run() {
			try {
				JSONObject param = new JSONObject();
				param.put("PARENTID", "");
				String response = HTTP.excuteAndCache("getRegionlistByParentid", "RestRegionService", param.toString(),WSBS2.this);
				JSONObject json = new JSONObject(response);
				String code = json.getString("code");
				if (("200".equals(code))) {
...
//						getString(MSFWResource.getResourseIdByName(WSBS2.this, "string", "tj_occurs_error_network")));
	...
	private class MyItemClick implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
			Intent intent = new Intent();
			if (currIndex == 1) {
				intent.setClass(WSBS2.this, PermListByDept.class);
				...
				intent.setClass(WSBS2.this, DeptList.class);
				intent.putExtra("WSBSFLAG", 1);
	...
	class MyHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case GET_REGION_SUCCESS:
				...
				dialog = Background.Process(WSBS2.this, InitIcon, "数据加载中");// 更新图标
				dialog = Background.Process(WSBS2.this, InitDeclareIcon, "数据加载中");// 更新图标
				break;
			case GET_DEPTS_SUCCESS:

				// if (currIndex == 1) {
				SimpleAdapter adapter = new SimpleAdapter(WSBS2.this, deptDatas,
						MSFWResource.getResourseIdByName(mContext, "layout", "tj_deptlist_item"),
						new String[] { "NAME" },
				...
				// } else {
				// SimpleAdapter adapter = new SimpleAdapter(WSBS2.this,
			...
			case GET_ZQDEPTS_SUCCESS:
				SimpleAdapter adapter2 = new SimpleAdapter(WSBS2.this, ZQdeptDatas, MSFWResource.getResourseIdByName(mContext, "layout", "tj_deptlist_item"), new String[] { "SHORTNAME" }, new int[] { MSFWResource.getResourseIdByName(mContext, "id", "deptName") });
				ZQDeptList.setAdapter(adapter2);
				ZQDeptList.setOnItemClickListener(new MyItemClick1());
				break;
			case GET_STREETS_SUCCESS:
				SimpleAdapter adapter1 = new SimpleAdapter(WSBS2.this, listItemDeclared,
						MSFWResource.getResourseIdByName(mContext, "layout", "tj_deptlist_item"),
						new String[] { "NAME" },
						new int[] { MSFWResource.getResourseIdByName(mContext, "id", "deptName") });
...
//		new AlertDialog.Builder(this).setMessage("你还没有绑定网上办事大厅账号，是否现在绑定？")
//				.setTitle(getString(MSFWResource.getResourseIdByName(WSBS2.this, "string", "tj_notify")))
//				.setCancelable(false).setPositiveButton("绑定", new DialogInterface.OnClickListener() {
//					public void onClick(DialogInterface dialog, int id) {
//						GloabDelegete gloabDelegete = Constants.getInstance().getGloabDelegete();
//						if (gloabDelegete != null) {
//							gloabDelegete.doBoundMSTAccount(WSBS2.this, username, password, new TransportCallBack() {
//
//								@Override
//								public void onStart() {
...
//					public void onClick(DialogInterface dialog, int id) {
//						intent = new Intent();
//						intent.setClass(WSBS2.this, Register.class);
//						startActivity(intent);
//					}
//				}).show();
//	}
	...
	static class MyHandler2 extends Handler {
		private WeakReference<WSBS2> logins;

		public MyHandler2(WSBS2 login) {
			logins = new WeakReference<WSBS2>(login);
		}

		@Override
		public void handleMessage(Message msg) {
			super.handleMessage(msg);
			WSBS2 login = logins.get();
			if (login == null) {
				return;
			}
			switch (msg.what) {
	...
	final Runnable Login = new Runnable() {
		...
		public void run() {
			try {
				...
				String response = HTTP.excuteAndCache("login", "RestUserService", param.toString(),WSBS2.this);
				final JSONObject json = new JSONObject(response);
				String code = json.getString("code");
				if (code.equals("200")) {
					Constants.user = JSONUtil.getGson().fromJson(json.getString("ReturnValue"), User.class);
					DialogUtil.showUIToast(WSBS2.this, "登录成功！");
				} else {
					String error = json.getString("error");
					DialogUtil.showUIToast(WSBS2.this, error);
				}
